...
from api.views import admin_authorization_page, admin_home, create_user, user_info, credit_applications, CustomTokenObtainPairView, UserInfoView, CreateCreditApplicationView, active_credits, confirm_credit, CreditListView
